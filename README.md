...
```
cd existing_repo
git remote add origin https://bbbhub.bbbaden.ch/P.Blattmann.inf21/to-do-list-294.git
git branch -M main
...
- [ ] [Set up project integrations](https://bbbhub.bbbaden.ch/P.Blattmann.inf21/to-do-list-294/-/settings/integrations)
